...
VALUES('2c9640817421617901742162f7240001', 'contato@dbo.com.br', 'Atendimento', 'EMAIL');
INSERT INTO dbo.pessoa_juridica_contatos
(pessoa_juridica_id, descricao, observacao, tipo_contato)
VALUES('2c9640817421617901742162f7240001', 'https://dbo.com.br', 'Site', 'SITE');
...
INSERT INTO dbo.unidade_contatos
(unidade_id, descricao, observacao, tipo_contato)
VALUES('2c96408174216d0d0174216eccf50001', 'centro@dbo.com.br', 'Atendimento', 'EMAIL');
INSERT INTO dbo.unidade_contatos
(unidade_id, descricao, observacao, tipo_contato)
VALUES('2c96408174216d0d0174216eccf50001', '(21) 2384-4983', 'Secretaria', 'TELEFONE');
INSERT INTO dbo.unidade_contatos
(unidade_id, descricao, observacao, tipo_contato)
VALUES('2c96408174216d0d01742170090b0005', 'barra@dbo.com.br', 'Atendimento', 'EMAIL');
...
INSERT INTO dbo.turma_ofertavagas
...
INSERT INTO dbo.inscricao_turma
...
insert into dbo.contrato (
	...
	null
from 
	dbo.inscricao_turma it 
inner join
	dbo.pessoa_fisica pf on pf.id = it.id_pessoa_fisica
WHERE 
	pf.id not in (select c.id_pessoa_fisica from dbo.colaborador c);
	

update dbo.contrato set texto_contrato = '<p><strong>CONTRATO DE PRESTA&Ccedil;&Atilde;O DE SERVI&Ccedil;OS E HONOR&Aacute;RIOS DE PROFISSIONAL AUT&Ocirc;NOMO</strong></p>
...
INSERT INTO dbo.inscricao_turma_resultadoAvaliacao
...
/* Histórico do Aluno */
INSERT INTO dbo.historico_aluno
